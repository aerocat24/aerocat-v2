...
class ControlP2PNode:
    ...
    def __init__(self):
        ...
        rospy.Subscriber("/boat/point_reached", Int32, self.point_reached_callback)
...
if __name__ == '__main__':
    ...
    rospy.init_node('control_p2p_node')

    #Inicia o objeto
    control_p2p_node = ControlP2PNode()
